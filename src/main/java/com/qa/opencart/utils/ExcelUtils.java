...
public class ExcelUtils {
	...
	public static Object[][] getTestData(String sheetName) {
		...
		Object data[][] = null;
		try {
			//here you hav to mention the path to access the file
			FileInputStream fip = new FileInputStream(TEST_DATA_SHEET_PATH);
			//you hav to give me the fip class object. so that we will create the excel sheet inside java.
			wbook =  WorkbookFactory.create(fip);
